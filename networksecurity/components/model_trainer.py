...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model,classificationmetric): 
        with mlflow.start_run(): 
            ...
            mlflow.sklearn.log_model(best_model,name= "my_model")
    ...
    def train_model(self,X_train,y_train,X_test,y_test):
        ...
        self.track_mlflow(best_model=best_model,classificationmetric=classfication_train_metric)
    ...
    def iniitate_model_trainer(self) -> ModelTrainerArtifact:
        try: 
